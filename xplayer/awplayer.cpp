...
static const int AWPLAYER_MESSAGE_PLAYER_START_FAIL     	= 0x207;
...
AwPlayer::~AwPlayer()
{
    ...
    if(mThreadCreated)
    {
        ...
        setMessage(&msg, AWPLAYER_COMMAND_QUIT, (unsigned int)&mSemQuit);
...
int AwPlayer::prepareAsync()
{
    ...
    setMessage(&msg,
               ...
               (unsigned int)&mSemPrepare,      //* params[0] = &mSemPrepare.
               (unsigned int)&mPrepareReply,    //* params[1] = &mPrepareReply.
...
int AwPlayer::start()
{
    ...
    setMessage(&msg,
               ...
               (unsigned int)&mSemStart,      //* params[0] = &mSemStart.
               (unsigned int)&mStartReply);   //* params[1] = &mStartReply.
    AwMessageQueuePostMessage(mMessageQueue, &msg);
...
int AwPlayer::stop()
{
    ...
    setMessage(&msg,
               ...
               (unsigned int)&mSemStop,      //* params[0] = &mSemStop.
               (unsigned int)&mStopReply);   //* params[1] = &mStopReply.
    AwMessageQueuePostMessage(mMessageQueue, &msg);
...
int AwPlayer::pause()
{
    ...
    setMessage(&msg,
               ...
               (unsigned int)&mSemPause,      //* params[0] = &mSemPause.
               (unsigned int)&mPauseReply);   //* params[1] = &mPauseReply.
    AwMessageQueuePostMessage(mMessageQueue, &msg);
...
int AwPlayer::seekTo(int msec)
{
    ...
    setMessage(&msg,
               ...
               (unsigned int)&mSemSeek,      //* params[0] = &mSemSeek.
               (unsigned int)&mSeekReply,    //* params[1] = &mSeekReply.
...
int AwPlayer::reset()
{
    ...
    setMessage(&msg,
               ...
               (unsigned int)&mSemReset,     //* params[0] = &mSemReset.
               (unsigned int)&mResetReply);  //* params[1] = &mResetReply.
    AwMessageQueuePostMessage(mMessageQueue, &msg);
...
int AwPlayer::setVolume(int volume)
{
    ...
    setMessage(&msg,
               ...
               (unsigned int)&mSemSetVolume,      //* params[0] = &mSemSetVolume.
               (unsigned int)&mSetVolumeReply,    //* params[1] = &mSetVolumeReply.
...
int AwPlayer::callbackProcess(int messageId, void* param)
{
	...
	case AWPLAYER_MESSAGE_PLAYER_VIDEO_RENDER_FRAME:
		...
		break;
	case AWPLAYER_MESSAGE_PLAYER_START_FAIL:
		{
			mNotifier(mUserData, NOTIFY_ERROR, NOTIFY_ERROR_TYPE_UNKNOWN, NULL);
            break;
		}
...
static int PlayerCallbackProcess(void* pUserData, int eMessageId, void* param)
{
    ...
    switch(eMessageId)
    {
        ...
        case PLAYER_NOTIFY_VIDEO_RENDER_FRAME:
            ...
            break;
		case PLAYER_NOTIFY_START_FAIL:
            msg = AWPLAYER_MESSAGE_PLAYER_START_FAIL;
            break;
